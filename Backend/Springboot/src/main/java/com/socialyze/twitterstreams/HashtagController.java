...
//	
	...
	public Employee updateProfile(@PathVariable String userId, @RequestParam("token")String token , @RequestBody Employee employee) {
		return getA.updateProfile(userId , token , employee);
	}
}